...
style.textContent = `@keyframes pulse{0%,100%{opacity:1}50%{opacity:0.3}} @keyframes load{from{width:0%}to{width:100%}} @keyframes spin{to{transform:rotate(360deg)}} *{box-sizing:border-box;margin:0;padding:0;} body{background:#f8fafc;} input::placeholder{color:#94a3b8;} ::-webkit-scrollbar{width:6px;} ::-webkit-scrollbar-track{background:#f1f5f9;} ::-webkit-scrollbar-thumb{background:#cbd5e1;border-radius:99px;}`;
